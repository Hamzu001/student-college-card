...
const Form = ({ formSubmit, loading }) => {
  return (
    <div>
      <form
        className="flex lg:mt-6 sm:mt-1 flex-row flex-wrap"
        onSubmit={formSubmit}
      >
        <div className="pl-24 pt-10">
          <div className="flex items-center flex-col justify-center w-full">
            <div className="rounded-md h-[260px] w-[210px] border-2 border-dashed p-2">
              <div className="rounded-md h-[240px] w-[190px] border-2">
                <img
            ...
            <input
              ...
              type="file"
              name="file"
              className="w-[210px] mt-1 border p-1"
              required
            />
          </div>
        </div>
